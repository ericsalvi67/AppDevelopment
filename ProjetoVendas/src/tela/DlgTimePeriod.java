 ...
 * @author pretto
 */
public class DlgTimePeriod extends javax.swing.JDialog {

    /**
     * Creates new form DlgRelOS
     */
    public DlgTimePeriod(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgTimePeriod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgTimePeriod dialog = new DlgTimePeriod(new javax.swing.JFrame(), true);
